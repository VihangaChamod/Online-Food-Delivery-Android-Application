...
@WebServlet(name = "showCompleteOrders", urlPatterns = {"/showCompleteOrders"})
public class showCompleteOrders extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          ResultSet rs1 = DBMS_Connection.DBMS.SE("SELECT * FROM `orders` WHERE `id`='"+rs.getString("orders_id")+"' AND `status`='Complete' GROUP BY`temp_id`");
