 ...
 * @author DELL
 */
@WebServlet(name = "cuzData", urlPatterns = {"/cuzData"})
public class cuzData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            JsonObject jo=null;
                  ...
                  ResultSet rs = DBMS_Connection.DBMS.SE("select * from `catalog` where id='"+id+"'");
